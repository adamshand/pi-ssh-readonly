...
- The **Agent Connect Tool** prompt hint includes the exact configured **SSHRO Host Whitelist** target strings, truncated after 20 entries, so the agent knows which targets can auto-connect without prompting.
